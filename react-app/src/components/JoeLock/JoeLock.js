...
// export default function JoeLock({ user }) {
...
//   const [partnerIsLocked, setPartnerIsLocked] = useState(true);
...
//             <Grid.Column>
//               <Message color="purple" size="massive" compact>
//                 Welcome <br />
//                 to JoeLock!
//               </Message>
//               <br />
...
//                     <br />
//                     {isNaN(bearing) ? (
//                       <div>Waiting for Joe to Join</div>
//                     ) : (
...
//                     </div>
//                     <Image src="/joe.png" alt="image" verticalAlign="middle" />
...
//                       miles away
//                       {partnerIsLocked ? "Joe is locked on!" : null}
//                     </Message>
...
//                 <Message.Header>Your JoeLock Id</Message.Header>
//                 {lockId}
//               </Message>
//             </Grid.Column>
//           </Grid.Row>
