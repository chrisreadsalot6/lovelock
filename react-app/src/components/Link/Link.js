...
export default function Link() {
  ...
  const getDirection = () => {
    if (detectIfMobileBrowser() === false) {
      alert('No device orientation event. Inputting placeholder value for compass direction. Please kindly use a mobile device for dynamic compass readings.')
  ...
  return (
    <div className='big-text'>
      ...
      { direcc === null ? null: <button onClick={ createATalk }>Start Your Talk</button> }
